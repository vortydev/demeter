...
function NewsPage(): JSX.Element {
  ...
  return (
    <section className="newsPage">
      ...
      {createdSuccess && (
        <Alert variant="success">L'annonce à été créée avec succès!</Alert>
      )}
      {editedSuccess && (
        <Alert variant="success">L'annonce à été modifiée avec succès!</Alert>
      )}
      {deleteSuccess && (
        <Alert variant="success">L'annonce à été supprimée avec succès!</Alert>
      )}
